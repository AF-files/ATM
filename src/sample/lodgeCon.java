...
public class lodgeCon {
    @FXML
    private BorderPane lodgePane;

    @FXML
    public void returnOrLeave(){
        Dialog<ButtonType> dialog = new Dialog<>();
        dialog.initOwner(lodgePane.getScene().getWindow());
    ...
    private void closeWindow(){
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("lodgement.fxml"));
            Parent root = loader.load();
            Stage closeStage = (Stage) lodgePane.getScene().getWindow();
